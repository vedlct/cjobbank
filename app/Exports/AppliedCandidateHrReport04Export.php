...
class AppliedCandidateHrReport04Export implements FromView
{
    use Exportable;
    ...
    public function __construct($newlist, $ethnicity, $education, $pQualification, $training, $jobExperience, $salaryInfo, $refree, $relativeList, $jobTitle, $withoutSalaryInfo, $excelName, $previousWorkExperienceInCB)
    {
    ...
    * @return View
    ...
    public function view(): View
    {
        return view('Admin.application.AppliedCandidateList')
            ...
            ->with('previousWorkExperienceInCBList', $this->previousWorkExperienceInCB);
    }
}
