            ...
            <div class="card-body">
                ...
                <div class="col-md-3">
                    ...
                    <div class="sidenav">
                        ...
                        <a class="incomplete" href="<?php echo e(route('changeemailtemplate.interviewcard')); ?>">Interview card</a>
                        <a class="incomplete" href="<?php echo e(route('changeemailtemplate.panellisted')); ?>">Panel listed</a>
                        <a class="incomplete" href="<?php echo e(route('changeemailtemplate.notselected')); ?>">Not selected</a>
                        <a class="incomplete" href="<?php echo e(route('changeemailtemplate.acknowledgement')); ?>">Acknowledgement</a>
                    </div>
