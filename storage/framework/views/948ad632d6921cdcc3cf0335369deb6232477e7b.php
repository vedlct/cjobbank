        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('manage.degisnation.insert')); ?>" method="post">
            ...
            <div class="card container">
                ...
                <div class="card-body">
                    ...
                    <table id="designationtable" class="table table-striped table-bordered" style="width:100%" >
                        ...
                        <?php $__currentLoopData = $degisnation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($d->designationName); ?></td>
                                <td>
                                    <?php $__currentLoopData = STATUS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($d->status == $key): ?>
                                            <?php echo e($value); ?>
                                ...
                                <td width="10%"><button class="btn btn-sm btn-success" data-panel-id="<?php echo e($d->designationId); ?>" onclick="editDegisnation(this)">Edit</button>
                                </td>
...
<?php $__env->startSection('foot-js'); ?>
    ...
    <script>
        ...
        function editDegisnation(x) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('admin.editDegisnation'); ?>",
                cache: false,
