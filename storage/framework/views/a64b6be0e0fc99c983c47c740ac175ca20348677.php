        ...
        <div class="col-12 ">
            <div class="card updateCard">
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <form class="col-md-9" id="regForm" action="<?php echo e(route('submit.refree')); ?>" method="post">
...
<hr>
                        ...
                        <div style="overflow:auto;" class="top">
                            <div style="float:right;">
                                ...
                                <a href="<?php echo e(route('relativeInCaritas.getRelationInfo')); ?>"><button type="button" id="btnNext" >Next</button></a>
