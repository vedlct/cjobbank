        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('manage.ethnicity.insert')); ?>" method="post">
                ...
                <div class="card-body">
                    ...
                    <table id="Ethnicitytable" class="table table-striped table-bordered" style="width:100%" >
                        ...
                        <?php $__currentLoopData = $ethnicity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($eth->ethnicityName); ?></td>

                                <td>
                                    <?php $__currentLoopData = STATUS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($eth->status == $key): ?>
                                            <?php echo e($value); ?>

                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td width="10%"><button class="btn btn-sm btn-success" data-panel-id="<?php echo e($eth->ethnicityId); ?>" onclick="editEthnicity(this)">Edit</button>
                                </td>
...
<?php $__env->startSection('foot-js'); ?>
    ...
    <script>
        ...
        function editEthnicity(x) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('admin.editEthnicity'); ?>",
                cache: false,
