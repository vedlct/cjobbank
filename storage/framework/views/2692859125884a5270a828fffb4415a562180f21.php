                ...
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="sidenav">
                            ...
                            <a  id="addfalse" href="<?php echo e(route('refree.index')); ?>">Referee</a>
                    ...
                    <form class="col-md-9" id="regForm" onsubmit="return chkSocialMemberShip()" action="<?php echo e(route('candidate.membershipInSocialNetwork.insert')); ?>" method="post">
