                ...
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="sidenav">
                            ...
                            <a href="<?php echo e(route('candidate.skill.index')); ?>" class="activeNav">Other skill information</a>
                            <a <?php if ($hasOtherSkill!='0'){?> onclick="return false;" class="incomplete"<?php } ?> href="<?php echo e(route('cv.OthersInfo')); ?>">Other information</a>
                    ...
                    <form class="col-md-9" id="regForm" onsubmit="return chkOtherSkill()"  action="<?php echo e(route('candidate.skill.insert')); ?>"  method="post">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="skill[]" class="form-control" id="skill" onchange="checkUnique(this)">
                                            ...
                                            <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($skill->id); ?>"><?php echo e($skill->skillName); ?></option>
                        ...
                        <div style="overflow:auto;">
                            <div style="float:right;">
                                <a href="<?php echo e(route('candidate.computerSkill.index')); ?>"><button type="button" id="btnPevious" >Back</button></a>
                                <button type="submit" id="submitBtn">Save</button>
                                <?php if($hasOtherSkill == 0 || $hasOtherSkill == 1): ?>
                                <a href="<?php echo e(route('cv.OthersInfo')); ?>"><button type="button" id="nextBtn" >Next</button></a>
                                <?php endif; ?>
