                ...
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="sidenav">
                            ...
                            <a class="activeNav" href="<?php echo e(route('candidate.cvProfessionalCertificate')); ?>">Professional certification</a>
                            <a <?php if ($hasProfCertificate!='0'){?> onclick="return false;" class="incomplete" <?php } ?> href="<?php echo e(route('JobExperience.index')); ?>">Job experience</a>
                    ...
                    <form class="col-md-9" id="regForm" name="regForm" action="<?php echo e(route('submit.cvProfessionalCertificate')); ?>" onsubmit="return chkProfessinalCertificate()" method="post">
                        ...
                        <div style="overflow:auto;">
                            <div style="float:right;">
                                <a href="<?php echo e(route('candidate.cvTrainingCertificate')); ?>"><button type="button" id="btnPevious">Back</button></a>
                                <button type="submit" id="submitBtn">Save</button>
                                <?php if($hasProfCertificate == 1 || $hasProfCertificate == 0): ?>
                                <a href="<?php echo e(route('JobExperience.index')); ?>"><button type="button" id="nextBtn" >Next</button></a>
                                <?php endif; ?>
                            </div>
                        </div>
