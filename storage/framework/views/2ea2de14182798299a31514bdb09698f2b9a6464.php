                ...
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="sidenav">
                            ...
                            <a  class="activeNav" href="<?php echo e(route('candidate.membershipInSocialNetwork.index')); ?>">Certification of membership in professional network/ forum</a>
                    ...
                    <div class="col-md-9" id="regForm">
                        ...
                        <div id="" class="tab">
                            ...
                            <?php ($tempHr=0); ?>
                            <?php $__currentLoopData = $socialMembership; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $socialMembership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($tempHr>0): ?>
                                    <div class="col-md-12"><hr style="border-top:1px dotted #000;"></div>
                                <?php endif; ?>
                                <div id="edit<?php echo e($socialMembership->membershipId); ?>">
                                    <div class="row">


                                        <div class="form-group col-md-10">
                                            <label for="inputEmail4">Name of network :</label>
                                            <?php echo e($socialMembership->networkName); ?>


                                        </div>

                                        <div class="form-group col-md-2 ">
                                            <button type="button" class="btn btn-info btn-sm " onclick="editInfo(<?php echo e($socialMembership->membershipId); ?>)"><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm " onclick="deleteMembership(<?php echo e($socialMembership->membershipId); ?>)"><i class="fa fa-trash"></i></button>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo e($socialMembership->membershipType); ?>


                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Duration :</label>
                                            <?php echo e($socialMembership->duration); ?>
                            ...
                            <form  action="<?php echo e(route('candidate.membershipInSocialNetwork.insert')); ?>" method="post">
                        ...
                        <div style="overflow:auto;">
                            <div style="float:right;">
                                <a href="<?php echo e(route('candidate.previousWorkInCB.index')); ?>"><button type="button" id="btnPevious" >Back</button></a>

                                <button type="submit" id="submitBtn">Save</button>

                                <a href="<?php echo e(route('refree.index')); ?>"><button type="button" id="nextBtn" >Next</button></a>
...
<?php $__env->startSection('foot-js'); ?>
    <script>
        ...
        function editInfo(x){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('candidate.membershipInSocialNetwork.edit'); ?>",
                cache: false,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo route('candidate.membershipInSocialNetwork.delete'); ?>",
                            cache: false,
                            data: {_token: "<?php echo e(csrf_token()); ?>",'id': x},
                            success: function (data) {
//                                console.log(data);
