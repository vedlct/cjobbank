                ...
                <div style="background-color: #F1F1F1" class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="sidenav">
                            ...
                            <a <?php if ($hasTrainingInfo!='0'){?> onclick="return false;" class="incomplete" <?php } ?> href="<?php echo e(route('candidate.cvProfessionalCertificate')); ?>">Professional certification</a>
                    ...
                    <form class="col-md-9" id="regForm" onsubmit="return chkTrainingCertificate()" action="<?php echo e(route('insert.cvTrainingCertificate')); ?>" method="post">
                        ...
                        <div id="" class="tab">
                            ...
                            <div style="overflow:auto;">
                                <div style="float:right;">
                                    ...
                                    <?php if($hasTrainingInfo == '1' || $hasTrainingInfo == '0'): ?>
                                        <a href="<?php echo e(route('candidate.cvProfessionalCertificate')); ?>"><button type="button" id="btnNext" >Next</button></a>
                                    <?php endif; ?>
