                        ...
                        <div id="" class="tab">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <label class="control-label">Do you have any previous work experience in Caritas Bangladesh?<span style="color: red" class="required">*</span></label>
                            ...
                            <div id="TextBoxesGroup">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="location[]" id="location" placeholder="Address"></textarea>
                                    </div>
...
//                    '<div class="col-md-12"> ' +
                    ...
                    '</div> ' +
                    '<div class="form-group col-md-12"> ' +
                    '<label for="inputEmail4">Work station<span style="color: red">*</span></label> ' +
