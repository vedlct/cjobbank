...
This has reference to your recent application and the subsequent formal <?php echo e($testDetails); ?> held on <?php echo e(date('dS F Y (l)',strtotime($testDate))); ?> for the post of <?php echo e($jobInfo->position); ?>.<br><br>
Please be informed that the other candidate has been selected for appointment in the
post of <?php echo e($jobInfo->position); ?> as determined by the
Recruitment Committee upon careful assessment of candidates applications and the
results of the <?php echo e($testDetails); ?>.<br><br>
                <span>
                    <?php echo $customBody; ?>
