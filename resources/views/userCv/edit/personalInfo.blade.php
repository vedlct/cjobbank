                        ...
                        <!-- One "tab" for each step in the form: -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" maxlength="20" name="telephone" class="form-control {{ $errors->has('telephone') ? ' is-invalid' : '' }}" value="{{ $personalInfo->telephone }}" id="" placeholder="">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="text" maxlength="20" name="personalMobile" class="form-control {{ $errors->has('personalMobile') ? ' is-invalid' : '' }}" value="{{ $personalInfo->personalMobile }}" id="" placeholder="">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" maxlength="20" name="alternativePhoneNo" class="form-control {{ $errors->has('alternativePhoneNo') ? ' is-invalid' : '' }}" value="{{ $personalInfo->alternativePhoneNo }}" id="" placeholder="">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" name="homeTelephone" maxlength="20" class="form-control {{ $errors->has('homeTelephone') ? ' is-invalid' : '' }}" value="{{ $personalInfo->homeNumber }}" id="" placeholder="">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  type="text" name="officeTelephone" maxlength="20" class="form-control {{ $errors->has('officeTelephone') ? ' is-invalid' : '' }}" value="{{$personalInfo->officeNumber }}" id="" placeholder="">
