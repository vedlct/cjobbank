    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div style="background-color: white;margin-bottom: 20px;" class="card-body ex3">
                            ...
                            <div class="modal-body" id="sendViewMail">
                                ...
                                <div id="email-send">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="zone_address">Address:</label>
                                    ...
                                    <div class="row" id="forinterview">
                                        <div class="col-md-3">
                                            <label for="totalSelected">Selected applicant:</label>
                ...
                <div class="form-group">
                    <label>Age From <span style="color: red">(Year)</span></label>
                    <input class="form-control" id="ageFromFilter" name="ageFromFilter" onkeypress="return isNumberKey(event)" type="number">
                </div>
                <div class="form-group">
                    <label>Age To <span style="color: red">(Year)</span></label>
                    <input class="form-control" id="ageToFilter" name="ageToFilter" onkeypress="return isNumberKey(event)" type="number">
                </div>
                <div class="form-group">
...
{{--                        <select data-placeholder="Choose a Country..."id="educationMajorFilter" class="chosen-select" multiple style="width:350px;" tabindex="4">--}}
                ...
                <div class="">
                    ...
                    <div class="form-group">
                        <label>From <span style="color: red">(Year)</span></label>
                        <input id="jobExperienceFromFilter" name="jobExperienceFromFilter" class="form-control" onkeypress="return isNumberKey(event)" type="number">
                    </div>
                    <div class="form-group">
                        <label>To <span style="color: red">(Year)</span></label>
                        <input id="jobExperienceToFilter" name="jobExperienceToFilter" class="form-control" onkeypress="return isNumberKey(event)" type="number">
                    </div>
                    <div class="form-group">
        ...
        function myfunchrreport04() {
            if ($('#jobTitle').val()!=""){
                ...
                if (products.length >0) {
                    $.ajax({
                        type: 'POST',
                        url: "{!! route('jobAppliedCadidate.admin.Exporthrreport04xls') !!}",
                        cache: false,
                        data: {'jobApply': products,'excelName':$('#excelName').val(),_token:"{{csrf_token()}}",jobTitle:$('#jobTitle').val()},
                        success: function (data) {
                            $('#SessionMessage').load(document.URL +  ' #SessionMessage');
